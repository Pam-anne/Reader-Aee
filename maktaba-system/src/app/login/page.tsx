...
import { Eye, EyeOff, BookOpen, Loader2, AlertCircle, Book } from 'lucide-react';
          ...
          <button
            ...
            className={`w-full py-3 px-4 rounded-lg font-medium transition-all duration-200 flex items-center justify-center gap-2 ${
              isLoading
                ...
                : 'bg-gradient-to-r from-blue-600 to-purple-600 hover:bg-blue-700 active:bg-blue-800'
            } text-white`}
          >
            {isLoading ? (
              <>
